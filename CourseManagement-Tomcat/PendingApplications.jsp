...
<html>
    <head>
        ...
        <meta charset="utf-8">
        <title>${currentUser.currentCourseBeingViewed} - Pending Applications</title>
    </head>
    <body>
        ...
        <div class="container">
            ...
            <div class="content innercontent">
                <nav>
                    <a href="NewBoard">Home</a> > <a href="CourseServlet?course=${currentUser.currentCourseBeingViewed}"><c:out value="${currentUser.currentCourseBeingViewed}"/></a> > <a href="AdverseRequestServlet?action=viewAdverseApplications">Adverse Applications</a> > <a href="#">Pending Applications</a>
                </nav>
                           ...
                           <table>
                               ...
                               <c:forEach var = "row" items="${result.rows}">
                                   <tr>
                                       ...
                                       <td>
                                           <a href="#"><div class="acceptButton">Accept</div></a>
                                           <a href="#"><div class="rejectButton">Reject</div></a>
                                       </td>
                                   </tr>
                               </c:forEach>
                           </table>
